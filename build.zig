...
pub fn build(b: *Builder) void {
    ...
    {
        const exe = b.addExecutable("hotkeyxcb", "src/demo_hook.zig");
        ...
        const run_step = b.step("run-iohook", "Run the app");
        run_step.dependOn(&run_cmd.step);
    }
    {
        const exe = b.addExecutable("hotkeyzig", "src/main.zig");
        exe.setTarget(target);
        exe.setBuildMode(mode);
        ...
        const run_step = b.step("run-xcb", "Run the app");
        run_step.dependOn(&run_cmd.step);
    }
}
